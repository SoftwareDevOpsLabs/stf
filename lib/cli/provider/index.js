...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('connect-graylog', { // @HY 2017-07-14 add new option for Graylog URL
      describe: 'The IP and port to graylog services.'
      , type: 'string'
      , default: '127.0.0.1:12110'
    })
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      var args = [
        'device'
      , '--serial', device.id
      , '--exclude', argv.exclude   // @HY 2017-07-15 Add exclude argument to exclude emulator devices
      , '--provider', argv.name
