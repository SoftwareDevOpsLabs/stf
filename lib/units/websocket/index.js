  ...
  io.on('connection', function (socket) {
    ...
    new Promise(function (resolve) {
            ...
            .then(function () {
              ...
              if (run_env === "device") {
                ...
                var payload = {
                  ...
                  ,testID: testID
                  ,command: commands
                  // ,timeout: 1000*60*60*8  // TODO: add this in web @HY 2017-06-18
                  ,timeout: 1000*10      // TODO: add this in web @HY 2017-06-18
                  ,package: package
      ...
      .finally(function () {
        ...
        log.error("+++ Clean up all listeners and subscriptions in websocket")
