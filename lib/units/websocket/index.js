  ...
  io.on('connection', function(socket) {
    ...
    new Promise(function(resolve) {
      socket.on('disconnect', resolve)
        ...
        .on('group.ee', function(channel, responseChannel, data) {
          joinChannel(responseChannel)
          push.send([
            channel
          , wireutil.transaction(
        ...
        .on('startTest', function(channel, data) {
          ...
          var exec = spawn(commands.shift(),commands)
          // 返回测试状态
          console.log(exec.pid)

          // @hy 2017-05-10
	  msg ="Test " + testID + " begins, PID=" + exec.pid
          var report = {
	    ...
	    if ((typeof code) === 'undefined' || code == null) {
          ...
          //push.send([
          //  channel
          //  , wireutil.envelope(new wire.StartTestMessage(
          //    data.serial,
          //    data.tester,
          //    data.commands
          //  ))
...
//adb shell monkey -p com.qihoo360.mobilesafe --throttle 500 --ignore-crashes --ignore-timeouts --ignore-security-exceptions --ignore-native-crashes --monitor-native-crashes -v 1000
